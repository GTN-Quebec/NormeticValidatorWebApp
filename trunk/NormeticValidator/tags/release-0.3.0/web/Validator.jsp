            ...
            <webuijsf:html binding="#{Validator.html1}" id="html1">
                ...
                <webuijsf:body binding="#{Validator.body1}" focus="form1:tabSet1:tab1:layoutPanel1:fileUpload1" id="body1" style="-rave-layout: grid">
                    <webuijsf:form binding="#{Validator.form1}" id="form1" style="">
                        ...
                        <h:panelGrid binding="#{Validator.mainPanel}" id="mainPanel" width="100%">
                            <h:panelGrid cellspacing="20" id="gridPanelHeader" style="width: 100%; height: 100%;">
                                <webuijsf:staticText binding="#{Validator.staticTextTitle}" id="staticTextTitle" style="margin: 10px; font-size: 24px" text="#{msg.validatorTitle}"/>
                                <webuijsf:staticText binding="#{Validator.staticTextDescription}" id="staticTextDescription" style="margin: 10px; font-size: 14px" text="#{msg.validatorDescription}"/>
                            </h:panelGrid>
                                ...
                                <webuijsf:tab actionExpression="#{Validator.tabUpload_action}" binding="#{Validator.tabUpload}" id="tabUpload"
                                    ...
                                    <webuijsf:panelLayout binding="#{Validator.layoutPanel1}" id="layoutPanel1" style="margin: 20px; width: 100%;">
                                        <h:panelGrid cellspacing="20" id="gridPanel2">
                                            ...
                                            <webuijsf:upload binding="#{Validator.fileUpload1}" columns="80" id="fileUpload1" preservePath="true" style="font-size: 14px" label="#{msg.Uploadtext2}"/>
                                            ...
                                            <webuijsf:messageGroup binding="#{Validator.messageGroup1}" id="messageGroup1" style="width: 100%; text-align: left;" title="#{msg.errorGroupTitle}"/>
                                        </h:panelGrid>
                                ...
                                <webuijsf:tab actionExpression="#{Validator.tabDirectInput_action}" binding="#{Validator.tabDirectInput}" id="tabDirectInput"
                                    ...
                                    <webuijsf:panelLayout binding="#{Validator.layoutPanel2}" id="layoutPanel2" style="margin: 20px; width: 100%">
                                        <h:panelGrid cellspacing="20" id="gridPanel1">
                                            ...
                                            <webuijsf:textArea binding="#{Validator.textAreaDirectInput}" columns="100" id="textAreaDirectInput" rows="20"
                                            ...
                                            <webuijsf:panelLayout id="layoutPanel3" panelLayout="flow">
                                                ...
                                                <webuijsf:button actionExpression="#{Validator.buttonClearDirectInput_action}"
                                                    binding="#{Validator.buttonClearDirectInput}" id="buttonClearDirectInput" immediate="true" style="font-size: 18px; width: 150px" text="#{msg.clearDirectInputText}"/>
                                            </webuijsf:panelLayout>
                                            <webuijsf:messageGroup binding="#{Validator.messageGroup2}" id="messageGroup2" style="width: 100%; text-align: left;" title="#{msg.errorGroupTitle}"/>
                                        </h:panelGrid>
                                    </webuijsf:panelLayout>
                                </webuijsf:tab>
                            </webuijsf:tabSet>
