...
<xs:schema xmlns="http://ltsc.ieee.org/xsd/LOM/vocab" xmlns:lom="http://ltsc.ieee.org/xsd/LOM" xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="http://ltsc.ieee.org/xsd/LOM/vocab" elementFormDefault="unqualified" version="IEEE LTSC LOM XML 1.0">
    <xs:annotation>
        <xs:documentation>
    ...
    <xs:import namespace="http://ltsc.ieee.org/xsd/LOM" schemaLocation="http://localhost:8080<%= request.getContextPath() %>/xsd/normetic/lom.xsd"/>
    <!-- Vocabulary data type declarations -->
    <!-- Source -->
    <xs:simpleType name="source">
        <xs:union memberTypes="lom:sourceValues lom:normeticSourceValues"/>
    </xs:simpleType>
    <!-- 1.7 Structure -->
    ...
    <xs:simpleType name="learningResourceType">
        <xs:union memberTypes="lom:learningResourceTypeValues lom:normeticLearningResourceTypeValues"/>
    </xs:simpleType>
    ...
    <xs:simpleType name="context">
        <xs:union memberTypes="lom:contextValues lom:normeticContextValues"/>
    </xs:simpleType>
    <!-- 5.8 Difficulty -->
